...
{    
    $sql = "SELECT * from ebac WHERE reg_no='$_GET[reg_no]'";
    ...
    if($count == 1)
    {
        ...
        $total = $language_1+$english+$economics+$business_studies+$accountancy+$cs_e+$cs_l;
        if($reg_no=="CM1421")
        {            
            $lang_id = "AB";
            $language_1 = "AB";
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $business_studies; ?></td>
                                    <td>100</td>
                                </tr>
                                <tr>
                                    <th scope="row">Accountancy</th>
                                    <td><?php echo $accountancy; ?></td>
                                    <td>100</td>
                                </tr>                                
                                <tr>
