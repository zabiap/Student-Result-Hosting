...
if(isset($_GET['id'])) {
    $sql = "SELECT * from pcmb WHERE id='$_GET[id]'";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $maths = "$row[maths]";			
        $biology_e = "$row[biology_e]";			
        $biology_l = "$row[biology_l]";
        $res = "$row[result]";
    }
    if($lang_id == 1){
        $kan = "selected";
...
if($_SERVER["REQUEST_METHOD"] == "POST") { 
    $sql = "UPDATE pcmb SET name='$_POST[name]', reg_no='$_POST[reg_no]', lang_id= '$_POST[lang_id]', language_1= '$_POST[lang_1]' , english='$_POST[english]', physics_e='$_POST[physics_e]', physics_l='$_POST[physics_l]', chemistry_e='$_POST[chemistry_e]', chemistry_l='$_POST[chemistry_l]', maths='$_POST[maths]', biology_e='$_POST[biology_e]', biology_l= '$_POST[biology_l]', result='$_POST[result]' WHERE id='$_GET[id]'";
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="biology_e" type="number" class="form-control" placeholder="Marks" value="<?php echo $biology_e; ?>" required/></td>
                                            <td><input name="biology_l" type="number" class="form-control" placeholder="Marks" value="<?php echo $biology_l; ?>" required/></td>
                                        </tr>
                                        <tr>
