...
<?php*/
    $sql = "INSERT INTO ebac 
            ...
            VALUES
            ('$_POST[name]', '$_POST[reg_no]', '$_POST[lang_id]', '$_POST[lang_1]', '$_POST[english]', '$_POST[economics]', '$_POST[buisness_studies]', '$_POST[accountancy]', '$_POST[cs_e]', '$_POST[cs_l]', '$_POST[result]')";
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><input name="economics" type="number" class="form-control" placeholder="Marks" required/></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Business Studies</th>
                                            <td colspan="2"><input name="buisness_studies" type="number" class="form-control" placeholder="Marks" required/></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Accountancy</th>
                                            <td colspan="2"><input name="accountancy" type="number" class="form-control" placeholder="Marks" required/></td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Computer Science</th>
                                            <td><input name="cs_e" type="number" class="form-control" name="" placeholder="Marks" required/></td>
                                            <td><input name="cs_l" type="number" class="form-control" name="" placeholder="Marks" required/></td>
                                        </tr>
                                        <tr>
