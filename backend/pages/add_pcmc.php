...
<?php*/
    $sql = "INSERT INTO pcmc 
            ...
            VALUES
            ('$_POST[name]', '$_POST[reg_no]', '$_POST[lang_id]', '$_POST[lang_1]', '$_POST[english]', '$_POST[physics_e]', '$_POST[physics_l]', '$_POST[chemistry_e]', '$_POST[chemistry_l]', '$_POST[maths]', '$_POST[cs_e]', '$_POST[cs_l]', '$_POST[result]')";
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input name="cs_e" type="number" class="form-control" placeholder="Marks" required/></td>
                                            <td><input name="cs_l" type="number" class="form-control" placeholder="Marks" required/></td>
                                        </tr>
                                        <tr>
