...
{    
    $sql = "SELECT * from pcmb WHERE reg_no='$_GET[reg_no]'";
    ...
    if($count == 1)
    {
        ...
        $total = $language_1+$english+$physics_e+$physics_l+$chemistry_e+$chemistry_l+$maths+$biology_e+$biology_l;        
    }    
}
?>
                    ...
                    <div class="col-md-12" style=" padding-left:0px; padding-right:0px;">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">Biology Theory</th>
                                    <td><?php echo $biology_e; ?></td>
                                    <td>70</td>
                                </tr>
                                <tr>
                                    <th scope="row">Biology Lab</th>
                                    <td><?php echo $biology_l; ?></td>
                                    <td>30</td>
                                </tr>
